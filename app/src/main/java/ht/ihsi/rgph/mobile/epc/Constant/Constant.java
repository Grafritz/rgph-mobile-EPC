 ...
 */
 public interface Constant {
    ...
    String DATABASE_NAME="rgph_epc_data-db";
   ...
   // LOGEMENT
    ...
    int Pitit_gason_Piti_fi_03 = 3;
    int Papa_Manman_06 = 6;
    int Pitit_Pitit_Gason_Pitit_Pitit_fi_07 = 7;

    int Wi_Preskole_1 = 1;
    int Wi_Prime_Fondamantal_1e_sik_2 = 2;
    int Wi_Prime_Fondamantal_2e_sik_3 = 3;
    int Wi_Segonde_Fondamantal_3e_sik_4 = 4;
    int Wi_Segonde_3e_Filo_5 = 5;
    int Wi_Inivesite_6 = 6;
    int Wi_Lekol_Pwofesyonel_7 = 7;
    int Non_Sant_Alfabetizasyon_8 = 8;
    int Non_Okenn_9 = 9;
    int Pa_Konnen_10 = 10;
