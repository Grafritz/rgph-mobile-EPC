...
public class MenageDao extends AbstractDao<Menage, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Qm11TotalIndividuVivant = new Property(5, Short.class, "qm11TotalIndividuVivant", false, "qm11TotalIndividuVivant");
        public final static Property Qm22AncienMembre = new Property(6, Short.class, "qm22AncienMembre", false, "qm22AncienMembre");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tbl_menage\" (" + //
                ...
                "\"qm11TotalIndividuVivant\" INTEGER," + // 5: qm11TotalIndividuVivant
                "\"qm22AncienMembre\" INTEGER," + // 6: qm22AncienMembre
    ...
    protected void bindValues(SQLiteStatement stmt, Menage entity) {
        ...
        Short qm11TotalIndividuVivant = entity.getQm11TotalIndividuVivant();
        if (qm11TotalIndividuVivant != null) {
            stmt.bindLong(6, qm11TotalIndividuVivant);
        }
 
        Short qm22AncienMembre = entity.getQm22AncienMembre();
        if (qm22AncienMembre != null) {
            stmt.bindLong(7, qm22AncienMembre);
        }
    ...
    public Menage readEntity(Cursor cursor, int offset) {
        Menage entity = new Menage( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getShort(offset + 5), // qm11TotalIndividuVivant
            cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6), // qm22AncienMembre
    ...
    public void readEntity(Cursor cursor, Menage entity, int offset) {
        ...
        entity.setQm11TotalIndividuVivant(cursor.isNull(offset + 5) ? null : cursor.getShort(offset + 5));
        entity.setQm22AncienMembre(cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6));
