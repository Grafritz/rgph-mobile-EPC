...
public class Main {
    ...
    //region [ CONSTANTS ]
    public static final int DATABASE_VERSION=1; // 25-09-2017
    ...
    public static final String TBL_ANCIEN_MEMBRE_OBJECT="tbl_ancien_membre";
